...
if __name__ =='__main__':
    t = time.ctime()
    print t
    # print(HumanDateTime('Thu Jun 21 14:44:21 2018'))
    nowTime = datetime.now().strftime('%Y-%m-%d %H:%M:%S')
    print nowTime
    print(HumanDateTime(nowTime).add_minute(5).strftime('%H:%M:%S'))
    # print datetime.strptime('2018-06-21 15:26:39',"%Y-%m-%d %H:%M:%S")
    # print(HumanDateTime('2017-02-02 00:00:00'))
    # print(HumanDateTime('2017-3-3'))